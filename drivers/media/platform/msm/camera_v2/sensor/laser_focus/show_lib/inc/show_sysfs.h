...
#define	LASER_K_REF_FILE	"/persist/LaserFocus_CalibrationRef.txt"

#define	LASER_K_DMAX_FILE	"/persist/LaserFocus_CalibrationDmax.txt"

#define LASERFOCUS_SENSOR_OFFSET_CALIBRATION_FACTORY_FILE		"/persist/LaserFocus_Calibration10.txt"
/* Path of cross talk file */
#define LASERFOCUS_SENSOR_CROSS_TALK_CALIBRATION_FACTORY_FILE		"/persist/LaserFocus_Calibration40.txt"
/* Path of Laura calibration data file */
#define LAURA_CALIBRATION_FACTORY_FILE		"/persist/laura_cal_data.txt"
/* shipping image */
