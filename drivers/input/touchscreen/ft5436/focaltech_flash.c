...
static unsigned char CTPM_FW[] = {
	...
	#include "Asus_501_5436_V06_D01_20160721_app.i"
#endif
#ifdef CONFIG_K89200_FEATURES
    #include "ZC553_5436_V06_D01_20160721_app.i"
#endif
};
...
int fts_ctpm_fw_upgrade_with_app_file(struct i2c_client *client, char *firmware_name)
{
	...
	{
		i_ret = fts_5x46_ctpm_fw_upgrade(client, aucFW_PRAM_BOOT, sizeof(aucFW_PRAM_BOOT));
