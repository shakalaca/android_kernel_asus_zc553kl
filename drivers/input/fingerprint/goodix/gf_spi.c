...
#define GF_SPIDEV_NAME     "goodix,fingerprint" //modified by yinglong.tang
...
struct gf_key_map key_map[] =
{
      ...
      {  "DCLICK",  KEY_F20    },
      {  "LPRESS",  KEY_F21    },
//modified begin by yangyang 199661
      {  "ASUS_UP",      KEY_F13    },
      {  "ASUS_DOWN",    KEY_F14    },
      {  "ASUS_LEFT",    KEY_F15    },
      {  "ASUS_RIGHT",   KEY_F16    },
      ...
      {  "ASUS_DCLICK",  KEY_F18    },
      {  "ASUS_LPRESS",  KEY_F22    },
//modified end by yangyang 199661
};
...
//      {  "ASUS_RIGHT",   KEY_F16    }
	      if (KEY_UP == gf_key.key) {
		      ...
		      input_report_key(gf_dev->input, KEY_F17, gf_key.value);
                      input_sync(gf_dev->input);
                      break;
	      } else if (KEY_F20 == gf_key.key) {
		      pr_info("Fingerprint key double click\n");
		      input_report_key(gf_dev->input, KEY_F18, gf_key.value);
                      input_sync(gf_dev->input);
                      break;
	      } else if (KEY_F21 == gf_key.key) {
...
/*
	if (gf_power_on(gf_dev))
        ...
        //add by xunanbin on 2016/09/13 for fingerprint in factory mode
